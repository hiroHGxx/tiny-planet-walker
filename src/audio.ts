...
/** メロディの1拍の長さ(秒)。エコーの間隔の基準(曲ごとのテンポは台帳が持つ) */
const BEAT = 0.42;

// メロディの中身は content/melodies.ts の台帳へ(曲を直すときはそちらだけ)
import { MELODIES, type MelodyMode } from './content/melodies.ts';
export { MELODIES, type MelodyMode };
