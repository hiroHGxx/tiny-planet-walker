...
export const HERB_ICONS: Readonly<Record<string, string>> = {
  ...
  shiokaze: `<svg viewBox="0 0 40 40">
  ...
  himawari: `<svg viewBox="0 0 40 40">
  ...
  momijitake: `<svg viewBox="0 0 40 40">
  ...
  yukiwari: `<svg viewBox="0 0 40 40">
